...
class aprxCML(CML):
    ...
    def landscape(self,res=0.1,sig_lower=0.1,sig_upper=4.0,den_lower=0.1,den_upper=6.0,file_name=None):
    	#run after maxLike
    	sig = np.arange(sig_lower,sig_upper,res)
    	den = np.arange(den_lower,den_upper,res)
